 ...
 */
final class Version20201118224316 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        $this->addSql('CREATE TABLE `movement` (
                ...
                CONSTRAINT FK_movement_group_if  FOREIGN KEY (group_id) REFERENCES `user_group` (id) ON UPDATE CASCADE ON DELETE CASCADE
